...
export const gamingPackageLists: PackageSections = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: 'proton.svg',
        description: 'gaming.protontricks',
      },
      {
        name: 'ProtonUp-Qt',
        pkgname: ['protonup-qt'],
        icon: 'protonup-qt.png',
        description: 'gaming.protonupQt',
      },
      ...
      { name: 'WINE', pkgname: ['wine'], icon: 'wine', description: 'gaming.winePackage' },
      {
        ...
        icon: 'wine',
        description: 'gaming.wineStaging',
      },
      {
        name: 'Winetricks',
        pkgname: ['winetricks'],
        icon: 'winetricks.png',
        description: 'gaming.winetricks',
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        pkgname: ['antimicrox'],
        icon: 'antimicrox.png',
        description: 'gaming.antimicrox',
      },
      {
        name: 'AnyDesk',
        pkgname: ['anydesk-bin'],
        icon: 'anydesk.svg',
        description: 'gaming.anydesk',
      },
      {
        name: 'CoreCtrl',
        pkgname: ['corectrl'],
      ...
      { name: 'Discord', pkgname: ['discord'], icon: 'discord.png', description: 'gaming.discord' },
      {
        ...
        pkgname: ['displaycal'],
        icon: 'displaycal.png',
        description: 'gaming.displaycal',
      },
      {
        name: 'DroidCam',
        pkgname: ['droidcam'],
        icon: 'droidcam.png',
        description: 'gaming.droidcam',
      },
      {
        name: 'EasyEffects',
        pkgname: ['easyeffects'],
        icon: 'easyeffects.svg',
        description: 'gaming.easyeffects',
      },
      {
        name: 'GOverlay',
        pkgname: ['goverlay'],
        icon: 'goverlay.png',
        description: 'gaming.goverlay',
      },
  ...
  },
  {
    ...
    sections: [
      ...
      {
        name: 'DuckStation',
        pkgname: ['duckstation-gpl'],
        icon: 'duckstation.png',
        description: 'gaming.duckstation',
      },
      {
